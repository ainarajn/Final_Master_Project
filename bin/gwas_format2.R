...
#ref_effect = TRUE
#maxp = 5e-8
#hapmap3 = "/Users/ainarajimeneznavarro/Desktop/TFM/Script/ldscore/hm3_SNPs_variant_id.tsv"
#gwas_dir = "/Users/ainarajimeneznavarro/Desktop/TFM/Script/Pruebas"
#gwas_name = "ukbb1.tsv.bgz"
...
if (length(missing_columns) > 0) {
  message("There is one or more columns missing, revise ", gwas_name, " file to verify the gwas. In case there is no missing column, please adjust the header to match the script requirements.")
