...
if [[ "$GENOME" == "hg19" || "$GENOME" == "hg38ToHg19" ]]; then
    COAL_FILE=/homes/users/ajimenez/scratch/gcat/relate/${POP}/coal/${POP}.coal
    INDIR=/homes/users/ajimenez/scratch/gcat/relate/${POP}/anc_mut
else
...
do
    ...
    OUTDIR=/homes/users/ajimenez/scratch/SNP_likelihoods_${GENOME}/ld_${LD}
    mkdir -p $OUTDIR
